      ...
      home: Scaffold(
          appBar: AppBar(
            ...
            actions: <Widget>[
              ...
              RawMaterialButton(
                constraints: BoxConstraints.tight(Size(80, 80)),
onPressed: (){           showModalBottomSheet(context: context, builder: ((builder) =>CustomisedBottomSheet(context)),
);
},
                child: InkWell(
            ...
            child: Stack(
              children:<Widget> [
                Wrap(
                    ...
                    children:[tempImage()/*,tempImage(),tempImage(),tempImage(),tempImage(),tempImage(),tempImage(),tempImage()*/]),
...
Widget tempImage()
{
  return Container(
    ...
    _photofile==null?AssetImage('images/photo1.jpg'):FileImage(File(_photofile.path)),fit: BoxFit.fitHeight,//add image location here
    ),
  ),
  );
